...
This tree was auto-generated by [Charcoal](https://github.com/danerwilliams/charcoal)`;
    ...
    it('replaces duplicated footers with one current footer', () => {
      const updatedFooter = `#### PR Dependency Tree
...
This tree was auto-generated by [Charcoal](https://github.com/danerwilliams/charcoal)`;
      ...
      const updatedPrBody = updatePrBodyFooter(existingBody, updatedFooter);

      expect(updatedPrBody).equal(
...
${updatedFooter}`
    ...
    it('preserves body text after the existing footer', () => {
      const existingBody = `Fix issue where dependency tree prints multiple times
...
Preserve this trailing text.`;

      const updatedPrBody = updatePrBodyFooter(existingBody, newFooter);

      expect(updatedPrBody).equal(`Fix issue where dependency tree prints multiple times
